...
public class ClienteDAO {
	...
	public boolean alterar(Cliente cliente) {
		String sql = "UPDATE cliente SET nome=?, rg=?, cpf=?, telefone=?, id=?  WHERE id=?";
		try {
			PreparedStatement stmt = connection.prepareStatement(sql);
	...
	public Cliente buscar(Integer id) {
		...
		try {
			...
			if (resultado.next()) {
				...
				cliente.setRg(resultado.getString("rg_cliente"));
				cliente.setCpf(resultado.getString("cpf_cliente"));
				cliente.setTelefone(resultado.getString("cpf_telefone"));
